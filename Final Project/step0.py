...
This script implements passive Brownian motion for an ensemble of particles. Nothing too fancy.
"""
...
class PassiveBrownianParticles:
    ...
    def update(self):
        # in completed code this will include motion along the gradient and the brownian motion
